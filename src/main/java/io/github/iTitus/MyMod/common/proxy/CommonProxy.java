...
public class CommonProxy implements IGuiHandler {
	...
	public void init(FMLInitializationEvent event) {
		NetworkRegistry.INSTANCE.registerGuiHandler(MyMod.instance, MyMod.proxy);
	...
	public void registerEntities() {
		...
		EntityRegistry.registerModEntity(EntityBullet.class, LibNames.BULLET_NAME, id++, MyMod.instance, 64, 10, true);
	}
